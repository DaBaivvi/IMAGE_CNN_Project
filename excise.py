#Wrire a function about forward/backward neural network
import numpy as np
class Linear:
...
#Cleanning the data, read data from csv and delete the missing werte and counter the means of each raw.
import pandas as pd
